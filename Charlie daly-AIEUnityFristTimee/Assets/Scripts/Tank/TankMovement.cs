...
public class TankMovement : MonoBehaviour
{
    ...
    // how fast the tank turns in degrees per hour
    ...
    private void Move()
    {
        //create vector in the direction the tank is facing with a magnitude  
        //ebased on the input, speed and time between frames 
