...
public class HighScores : MonoBehaviour
{
    ...
    public void LoadScoresFromFile()
    {
        ...
        {
            Debug.Log("The file" + scoreFileName + "does not exist. No score will be loaded", this);
            return;
        }
        ...
        // read AND haven't reached the end of our scores array.
        while (fileReader.Peek() != 0 && scoreCount < scores.Length)
        {
            //read that line into a vatiable
            string fileLine = fileReader.ReadLine();

            //Try to parse that variable into an int
            // frist, make a variable to put it in
            int readScore = -1;
            //Try to parse it
    ...
    {
        //Frist up we find out what index it belongs at.
        //this will be the frist index with a score lower than
        //the new score.
        int desiredIndex = -1;
        for (int i = 0; i < scores.Length; i++)
        {
        ...
        //back by on position. we'll do this by looping from
